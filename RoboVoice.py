...
convI = ['oi', 'olá', 'olá, bom dia', 'bom dia', 'como vai', 'estou bem','legal','joia','numeros aleatorios','sei','certo','Tá','ok','então é isso','entendeu','entendi sim','filme','gosto daquele filme que os robôs se viram contra a humanidade']
